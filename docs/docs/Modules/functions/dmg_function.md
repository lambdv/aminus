...
This module provides the `DMGFunction` struct with methods to calculate damage using the full damage formula, including elemental reactions, critical hits, defense, and resistance calculations.
