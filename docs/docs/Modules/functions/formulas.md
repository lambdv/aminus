...
This module contains the core mathematical formulas used for damage calculations, including stat calculations, critical hit multipliers, defense and resistance multipliers, and the complete damage formula.
