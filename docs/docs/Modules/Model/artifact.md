...
This module provides the `Artifact` enum and `ArtifactSpec` struct which represent in-game artifacts with their rarity, level, main stat, and substats. It also defines constants for possible main stats for different artifact pieces.
