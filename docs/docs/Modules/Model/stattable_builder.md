...
This module provides the `StatTableBuilder` struct which implements the builder pattern for creating stat tables. It allows for lazy building and computing of stat tables from many statables and computed values.
