...
This module provides the `Rotation` struct which represents a sequence of actions performed by a character. It stores operations in a HashMap and can evaluate the total damage or effect of all actions based on a given statable.
