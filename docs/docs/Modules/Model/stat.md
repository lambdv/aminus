...
Represents a Attribute type and related enums for damage calculations.

## Description

This module defines the core `Stat` enum that represents all possible character attributes, along with supporting enums for damage types, elements, scaling types, amplifiers, and reaction types used throughout the damage calculation system.
